...
export default defineConfig({
  ...
  shortcuts: {
    ...
    "site-header":
      "sticky top-0 z-50 border-b border-border [background-color:var(--ui-comp-navbar-bg)] [color:var(--ui-comp-navbar-fg)] backdrop-blur",
    "nav-shell": "flex min-h-16 flex-wrap items-center gap-4 py-3",
    "brand-pill":
      "inline-flex items-center gap-2 text-navbar-foreground no-underline transition-colors hover:text-primary",
    "brand-dot": "size-2.5 rounded-full bg-primary",
    "nav-link":
      "rounded-md px-2.5 py-1.5 text-muted-foreground no-underline transition-colors hover:bg-accent hover:text-accent-foreground",
    "is-active": "bg-accent text-accent-foreground",
    "display-title": "font-display text-foreground",
    "island-kicker":
      "text-[0.72rem] font-semibold uppercase tracking-[0.18em] text-muted-foreground",
    "island-shell": "border border-border bg-overlay text-overlay-foreground",
    "feature-card": "transition-colors hover:border-ring",
    ...
    "field-label": "text-sm font-semibold text-foreground",
    "field-control":
      "w-full rounded-md border [border-color:var(--ui-comp-input-border)] [background-color:var(--ui-comp-input-bg)] px-3 py-2.5 text-sm [color:var(--ui-comp-input-fg)] outline-none transition-colors placeholder:[color:var(--ui-comp-input-placeholder-fg)] focus:border-ring focus-visible:outline-2 focus-visible:outline-ring focus-visible:outline-offset-2",
  },
